javascript: (
    function () {function extractPolicyNumber(fileName) {
    ...
    async function selectDocType(checkbox, delay,rows) {
        ...
        dropdown.click();
        await delay(10);
        var dropdownMenu = document.getElementsByClassName("k-child-animation-container");
        var ulContext = dropdownMenu[0].firstChild.lastChild.children[1].firstChild.children[7];
        ulContext.click();
